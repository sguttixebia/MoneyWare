...
import com.moneyware.application.service.MWFileStorageServiceImpl;
...
public class MWFileControllerTests {
    ...
    @Mock
    private MWFileStorageServiceImpl service;

    @InjectMocks
    MWFileController controller;
